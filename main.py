...
def eval_policy(policy, env_name, task_name, seed, eval_episodes=10):
	environment_kwargs = {'flat_observation': True}
	eval_env = suite.load(domain_name=env_name, task_name=task_name, environment_kwargs=environment_kwargs)
...
if __name__ == "__main__":
	...
	file_name = f"{args.policy}_{args.domain}_{args.seed}"
	print("---------------------------------------")
	print(f"Policy: {args.policy}, Domain: {args.domain}, Task: {args.task}, Seed: {args.seed}")
	print("---------------------------------------")
	...
	for t in range(int(args.max_timesteps)):
		...
		replay_buffer.add(state['observations'], action, next_state['observations'], reward, done)
